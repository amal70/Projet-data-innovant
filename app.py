...
st.sidebar.page_link("pages/1_Accueil.py", label="🏠 Accueil")
st.sidebar.page_link("pages/2_Impact_Environnemental.py", label="📊 Impact Environnemental")
st.sidebar.page_link("pages/3_Benefices.py", label="🔍 Les Bénéfices du Vélo Mécanique")
st.sidebar.page_link("pages/4_Sensibilisation.py", label="🌍 Sensibilisation")
st.sidebar.page_link("pages/5_Passons_à_l'action.py", label="✅ Passons à l'action !")
